...
use MovieBundle\Entity\Utilisateurs;
use MovieBundle\Form\UtilisateursType;
...
class UtilisateursController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $utilisateurs = $em->getRepository('MovieBundle:Utilisateurs')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('MovieBundle\Form\UtilisateursType', $utilisateur);
    ...
    {
        $deleteForm = $this->createDeleteForm($utilisateur);
        $editForm = $this->createForm('MovieBundle\Form\UtilisateursType', $utilisateur);
